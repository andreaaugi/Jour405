...
```{r}
students <- read_csv("https://r4ds.hadley.nz/data-import")
```
...
I am honestly not sure if I am doing this right. Please let me know if everything looks good so I know I am on the right track. Thank you! :)
